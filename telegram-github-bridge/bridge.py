...
def handle_message(update: dict) -> bool:
    ...
    if text == "📈 اهرم":
        send_message(
            "📈 اهرم ترجیحی (سقف)\n\nبرای هر بازار، کمترین مقدار بین همین عدد و حداکثر مجاز خودِ آن "
            "بازار در نوبیتکس استفاده می‌شود — مثلاً روی بیت‌کوین/اتریوم که تا 10x مجازند، اگر این سقف "
            "10 یا بیشتر باشد همیشه 10x معامله می‌شود.",
            inline_keyboard=[
